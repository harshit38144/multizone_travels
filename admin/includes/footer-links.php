...
<?php
$adminFooterPage = basename($_SERVER['SCRIPT_NAME'] ?? '');
if ($adminFooterPage === 'dashboard.php') :
?>
<!-- AdminLTE dashboard demo (dashboard page only) -->
...
<script src="custom/tabs.js?v=3"></script>
