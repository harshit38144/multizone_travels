...
$qWizardSteps = [
    ...
    ['id' => 5, 'label' => 'Inclusions', 'color' => '#e11d2e', 'icon' => 'fas fa-check-circle'],
    ['id' => 6, 'label' => 'Terms & Policies', 'color' => '#e11d2e', 'icon' => 'fas fa-shield-alt'],
    ['id' => 7, 'label' => 'Pricing', 'color' => '#e11d2e', 'icon' => 'fas fa-rupee-sign'],
];
?>
<!DOCTYPE html>
<html>
...
<head>
    ...
    <style>
        ...
        .crm-quotation-gen .q-card-accordions .q-terms-list {
            display: flex;
            flex-direction: column;
            gap: 0.65rem;
        }

        .crm-quotation-gen .q-card-accordions .q-terms-item,
        .crm-quotation-gen .q-card-accordions .q-accordion-item {
        ...
        .crm-quotation-gen .q-card-accordions .q-terms-item-head,
        .crm-quotation-gen .q-card-accordions .q-accordion-head {
            background: #fff;
        ...
        .crm-quotation-gen .q-card-accordions .q-terms-item-head:hover,
        .crm-quotation-gen .q-card-accordions .q-accordion-head:hover {
            background: #fafbfc;
        }

        .crm-quotation-gen .q-card-accordions .q-terms-item-head:not(.collapsed),
        .crm-quotation-gen .q-card-accordions .q-accordion-head:not(.collapsed) {
            border-bottom-color: #eef2f7;
        }

        .crm-quotation-gen .q-card-accordions .q-accordion-head.collapsed {
            border-bottom: none;
        }
        ...
        .crm-quotation-gen .q-card-accordions .q-terms-item-head .toggle-icon,
        .crm-quotation-gen .q-card-accordions .q-accordion-head i.toggle-icon {
            flex-shrink: 0;
            color: #e11d2e;
            font-size: 0.72rem;
            width: auto;
        ...
        .crm-quotation-gen .q-card-accordions .q-terms-item-body,
        .crm-quotation-gen .q-card-accordions .q-accordion-body {
            padding: 0.85rem 1rem 1rem;
            background: #fff;
        }

        .crm-quotation-gen .q-card-accordions .note-editor.note-frame {
            border: 1px solid #e8ecf1;
            border-radius: 10px;
            overflow: hidden;
            box-shadow: none;
        ...
        .crm-quotation-gen .q-card-accordions .note-toolbar {
            background: #f8fafc !important;
            border-bottom: 1px solid #eef2f7 !important;
        }

        .crm-quotation-gen .q-card-accordions .note-editing-area .note-editable {
            background: #fff;
            color: #0f172a;
            min-height: 140px;
        }
        ...
        .crm-quotation-gen .q-day-svc-dd {
            position: relative;
            flex-shrink: 0;
        }

        .crm-quotation-gen .q-day-svc-btn {
        ...
        .crm-quotation-gen .q-day-svc-btn:hover,
        .crm-quotation-gen .q-day-svc-btn:focus {
            background: #f8fafc;
            border-color: #cbd5e1;
            color: #0f172a;
        }

        .crm-quotation-gen .q-day-svc-btn.is-set {
            border-color: #e11d2e;
            color: #be123c;
            background: #fff1f2;
        }

        .crm-quotation-gen .q-day-svc-btn.is-set:hover,
        .crm-quotation-gen .q-day-svc-btn.is-set:focus {
            background: #ffe4e6;
            border-color: #e11d2e;
            color: #9f1239;
        }

        .crm-quotation-gen .q-day-svc-caret {
            font-size: 0.58rem;
            opacity: 0.75;
        }

        .crm-quotation-gen .q-day-svc-menu {
            min-width: 11.5rem;
            padding: 0.35rem 0;
            border: 1px solid #e2e8f0;
            border-radius: 10px;
        ...
        .crm-quotation-gen .q-day-svc-option {
            display: flex;
            align-items: center;
            gap: 0.45rem;
            font-size: 0.82rem;
        ...
        .crm-quotation-gen .q-day-svc-option:hover {
            background: #f8fafc;
            color: #0f172a;
        }

        .crm-quotation-gen .q-day-svc-option.active {
            background: #fff1f2;
            color: #be123c;
        }

        .crm-quotation-gen .q-day-svc-check {
            width: 0.85rem;
            font-size: 0.65rem;
            opacity: 0;
            color: #c4121a;
        ...
        .crm-quotation-gen .q-day-svc-option.active .q-day-svc-check {
            opacity: 1;
        }

        .crm-quotation-gen .q-day-svc-option-sub {
            font-size: 0.7rem;
            font-weight: 500;
            color: #94a3b8;
            margin-left: 0.15rem;
        ...
        .crm-quotation-gen .q-day-svc-option.active .q-day-svc-option-sub {
            color: #fb7185;
        }
        ...
        .crm-quotation-gen .q-day-nav-btn.q-view-full-itinerary {
            width: 36px;
            height: 36px;
            padding: 0;
            justify-content: center;
        ...
        .q-full-itin-item-body {
            flex: 1 1 auto;
            min-width: 0;
        }

        .q-full-itin-item-photo {
            flex: 0 0 112px;
            width: 112px;
            height: 84px;
            border-radius: 10px;
        ...
        .crm-quotation-gen .q-flight-segment-row .q-ft-col-fare.is-connecting-locked .form-control,
        .crm-quotation-gen .q-flight-segment-row .q-ft-col-supplier.is-connecting-locked .form-control,
        .crm-quotation-gen .q-flight-segment-row .q-ft-col-fare.is-connecting-locked .select2-selection,
        .crm-quotation-gen .q-flight-segment-row .q-ft-col-supplier.is-connecting-locked .select2-selection {
        ...
        .crm-quotation-gen .q-flight-segment-row .q-ft-col-fare.is-connecting-locked .q-ft-label,
        .crm-quotation-gen .q-flight-segment-row .q-ft-col-supplier.is-connecting-locked .q-ft-label {
            color: #94a3b8;
        }
        ...
        #qWizardSection3 .q-hotel-table-head {
            display: grid;
        ...
        #qWizardSection3 .q-hotel-head-accom,
        #qWizardSection3 .q-hotel-head-commercial {
            min-width: 0;
            display: flex;
            flex-direction: column;
        }
        ...
        #qWizardSection3 .q-hotel-group-title {
            display: flex;
            align-items: center;
            gap: 0.4rem;
        ...
        #qWizardSection3 .q-hotel-group-title i {
            color: #e11d2e;
            font-size: 0.78rem;
            width: 1rem;
            text-align: center;
        ...
        #qWizardSection3 .q-hotel-col-labels {
            display: grid;
            gap: 0.35rem;
            align-items: center;
        ...
        #qWizardSection3 .q-hotel-col-labels span {
            display: inline-flex;
            align-items: center;
            gap: 0.28rem;
            min-width: 0;
        ...
        #qWizardSection3 .q-hotel-col-labels i {
            color: #e11d2e;
            font-size: 0.68rem;
            width: 0.85rem;
            text-align: center;
        ...
        #qWizardSection3 .q-hotel-col-labels-accom {
            grid-template-columns: 1.05fr 1.15fr 1.05fr 0.55fr 0.55fr 0.5fr 0.85fr 0.85fr;
        }

        #qWizardSection3 .q-hotel-col-labels-commercial {
            grid-template-columns: 0.95fr 1.2fr 72px;
        }
        ...
        #qWizardSection3 .q-hotel-accom,
        #qWizardSection3 .q-hotel-commercial {
            display: grid;
            gap: 0.35rem;
            align-items: center;
            min-width: 0;
        ...
        #qWizardSection3 .q-hotel-rate-box {
            display: flex;
            align-items: center;
            gap: 0.2rem;
            min-height: 38px;
        ...
        #qWizardSection3 .q-hotel-rate-prefix {
            color: #e11d2e;
            font-weight: 800;
            font-size: 0.82rem;
            flex-shrink: 0;
        ...
        #qWizardSection3 .q-hotel-rate-box .h-rate {
            border: 0 !important;
            background: transparent !important;
            box-shadow: none !important;
        ...
        #qWizardSection3 .q-hotel-rate-box .h-rate:focus {
            box-shadow: none !important;
        }
        ...
        #qWizardSection3 .q-hotel-row-more,
        #qWizardSection3 .q-hotel-row-remove {
            width: 32px;
            height: 32px;
            padding: 0;
            border-radius: 8px;
        ...
        #qWizardSection3 .q-hotel-row-more:hover {
            background: #f8fafc;
            color: #0f172a;
        }
        ...
        #qWizardSection3 .q-hotel-row-remove:hover {
            background: #fef2f2;
            color: #be123c;
        }
        ...
        #qWizardSection3 .q-hotel-field-city .q-hotel-ico {
            color: #e11d2e;
        }
        ...
        /* Hotel supplier Select2 — match commercial pink zone */
        #qWizardSection3 .q-hotel-field-supplier .select2-container--default .select2-selection--single {
            height: 38px !important;
            min-height: 38px !important;
            border: 1px solid #e2e8f0 !important;
            border-radius: 10px !important;
        ...
        #qWizardSection3 .q-hotel-field-supplier .select2-container--default .select2-selection--single .select2-selection__rendered {
        ...
        #qWizardSection3 .q-hotel-field-supplier .select2-container--default .select2-selection--single .select2-selection__arrow {
        ...
        @media (max-width: 1200px) {
            ...
            #qWizardSection3 .q-hotel-commercial,
            #qWizardSection3 .q-hotel-col-labels-commercial {
                grid-template-columns: 1fr 1.2fr 72px;
            }
            #qWizardSection3 .q-hotel-field-action {
                justify-self: end;
            }
        ...
        .crm-quotation-gen .q-hotel-field-meal .q-hotel-meal-menu {
            right: auto;
            width: max(280px, 100%);
            min-width: 280px;
        ...
        .crm-quotation-gen .q-hotel-field-meal .q-hotel-menu-item .q-hotel-menu-sub {
            white-space: normal;
            line-height: 1.3;
        }
        ...
        .qfs-flight-search .qfs-baggage-meta i {
            color: #c62828;
            width: 11px;
            text-align: center;
        }

        .qfs-flight-search .qfs-card-baggage {
            margin-top: 4px;
            display: flex;
            flex-wrap: wrap;
            gap: 6px 10px;
        ...
        .qfs-flight-search .qfs-card-baggage span {
            display: inline-flex;
            align-items: center;
            gap: 4px;
            background: #fff;
        ...
        .qfs-flight-search .qfs-card-baggage i {
            color: #c62828;
            font-size: 9px;
        }
        ...
        .crm-quotation-gen .q-wizard-step[data-q-step="7"] .q-pricing-grid {
            gap: 1rem;
        }

        .crm-quotation-gen .q-wizard-step[data-q-step="7"] .q-cost-sheet {
            padding: 0;
            background: transparent;
            border: 0;
            border-radius: 0;
        ...
        .crm-quotation-gen .q-wizard-step[data-q-step="7"] input.form-control:not(.cc-label) {
            text-align: right;
            font-variant-numeric: tabular-nums;
        }

        .crm-quotation-gen .q-wizard-step[data-q-step="7"] input[type="number"] {
            -moz-appearance: textfield;
            appearance: textfield;
        }

        .crm-quotation-gen .q-wizard-step[data-q-step="7"] input[type="number"]::-webkit-outer-spin-button,
        .crm-quotation-gen .q-wizard-step[data-q-step="7"] input[type="number"]::-webkit-inner-spin-button {
            -webkit-appearance: none;
            margin: 0;
        }

        .crm-quotation-gen .q-wizard-step[data-q-step="7"] .q-pricing-card {
            background: transparent;
            border: 0;
            box-shadow: none;
            padding: 0;
        ...
        .crm-quotation-gen .q-pricing-sheets-host {
            display: grid;
            grid-template-columns: minmax(148px, 168px) repeat(var(--q-opt-count, 1), minmax(260px, 1fr));
            gap: 0.75rem;
            align-items: stretch;
            overflow-x: auto;
        ...
        .crm-quotation-gen .q-pricing-sheets-host.is-single-option {
            grid-template-columns: minmax(148px, 168px) minmax(320px, 1fr);
        }
        ...
        .crm-quotation-gen .q-pricing-option-sheet.is-active {
            background: #fff;
            box-shadow: 0 0 0 2px rgba(196, 18, 26, 0.18), 0 10px 28px rgba(185, 28, 28, 0.12);
        }
        ...
        .crm-quotation-gen .q-pricing-option-hd {
            ...
            background: linear-gradient(135deg, #8b1020 0%, #c4121a 55%, #e11d48 100%);
            border-bottom: 0;
            color: #fff;
            box-sizing: border-box;
        }
        ...
        .crm-quotation-gen .q-pricing-option-sheet.is-active .q-pricing-option-hd {
            background: linear-gradient(135deg, #9f1239 0%, #c4121a 45%, #e11d48 100%);
        }
        ...
        .crm-quotation-gen .q-pricing-option-badge.is-selected i {
            color: #10b981;
            font-size: 0.62rem;
        }
        ...
        .crm-quotation-gen .q-pricing-row-label:not(.is-continuation):not(.q-pricing-add-label):not(.q-pricing-custom-label) {
            background: #fff5f5;
            border-left-color: #c4121a;
        }
        ...
        .crm-quotation-gen .q-pricing-row-ico {
            flex: 0 0 18px;
            width: 18px;
            color: #6b7280;
            font-size: 0.82rem;
        ...
        .crm-quotation-gen .q-pricing-amount-cell.has-remove .q-pricing-amount-input-wrap {
            margin-left: auto;
        }

        .crm-quotation-gen .q-pricing-amount-action {
            flex: 0 0 28px;
            width: 28px;
            min-width: 28px;
            height: 32px;
        ...
        .crm-quotation-gen .q-pricing-supplier-remove {
            flex: none;
            width: 28px;
            height: 32px;
            padding: 0;
        ...
        .crm-quotation-gen .q-pricing-amount-cell:hover .q-pricing-supplier-remove,
        .crm-quotation-gen .q-pricing-amount-cell:focus-within .q-pricing-supplier-remove {
            color: #64748b;
        }

        .crm-quotation-gen .q-pricing-supplier-remove:hover {
            color: #e11d2e;
            background: #fef2f2;
            border-color: #fecaca;
        }
        ...
        .crm-quotation-gen .q-tour-cost-hd-copy {
            min-width: 0;
        }
        ...
        .crm-quotation-gen .q-tour-cost-sub {
            margin: 0.2rem 0 0;
            font-size: 0.7rem;
            font-weight: 500;
        ...
        .crm-quotation-gen .q-tour-cost-row.has-child-age .q-tour-cost-traveller {
            flex: 0 0 auto;
            min-width: auto;
        }

        .crm-quotation-gen .q-tour-cost-row.has-child-age .q-tour-cost-traveller-text {
            flex: 0 0 auto;
        ...
        .crm-quotation-gen .q-tour-cost-child-age-label {
            display: inline-flex;
            align-items: center;
            flex-wrap: nowrap;
            gap: 0.35rem;
        ...
        .crm-quotation-gen .q-tour-cost-child-name {
            flex-shrink: 0;
            line-height: 24px;
        }

        .crm-quotation-gen .q-tour-cost-child-age-unit {
            display: inline-flex;
            align-items: center;
            height: 24px;
            font-size: 0.72rem;
        ...
        .crm-quotation-gen .q-tour-age-input {
            position: static;
            border: 0 !important;
            outline: none !important;
            box-shadow: none !important;
        ...
        .crm-quotation-gen .q-tour-age-input:focus {
            background: #e5e7eb !important;
        }

        .crm-quotation-gen .q-tour-cost-traveller-sub {
            display: block;
            font-size: 0.68rem;
            font-weight: 500;
            color: #94a3b8;
        ...
        .crm-quotation-gen .q-tour-cost-controls {
            display: inline-flex;
            align-items: center;
            gap: 0.35rem;
            flex: 0 0 auto;
        ...
        .crm-quotation-gen .q-tour-cost-rate-group,
        .crm-quotation-gen .q-tour-cost-gst-group {
            display: inline-flex;
            align-items: stretch;
            overflow: hidden;
            border-radius: 8px;
        ...
        .crm-quotation-gen .q-tour-cost-gst-suffix {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            padding: 0 0.45rem;
        ...
        .crm-quotation-gen .q-tour-cost-qty-group {
            display: inline-flex;
            align-items: center;
            height: 30px;
            border-radius: 8px;
        ...
        .crm-quotation-gen .q-tour-cost-meta-rate {
            display: inline-block;
            min-width: 4.2rem;
            color: #0f172a;
            font-size: 0.78rem;
        ...
        .crm-quotation-gen .q-tour-cost-action {
            flex: 0 0 28px;
            width: 28px;
            min-width: 28px;
            height: 28px;
        ...
        .crm-quotation-gen .q-tour-child-remove {
            flex: none;
            width: 28px;
            height: 28px;
            padding: 0;
        ...
        .crm-quotation-gen .q-tour-child-remove:hover {
            color: #e11d2e;
            background: #fef2f2;
            border-color: #fecaca;
        }
        ...
        .crm-quotation-gen .q-tour-cost-card .q-tour-cost-opts {
            display: flex;
            flex-wrap: wrap;
            align-items: center;
            gap: 0.55rem 1.15rem;
        ...
        .crm-quotation-gen .q-tour-opt-check {
            display: inline-flex;
            align-items: center;
            gap: 0.45rem;
            margin: 0;
        ...
        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-traveller {
            flex: 1 1 auto;
            min-width: 0;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-row.has-child-age .q-tour-cost-traveller {
            flex: 0 0 auto;
            min-width: auto;
            max-width: none;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-row.has-child-age .q-tour-cost-traveller-text {
            flex: 0 0 auto;
            min-width: max-content;
            overflow: visible;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-row.has-child-age .q-tour-cost-child-age-label,
        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-row.has-child-age .q-tour-cost-child-age-unit {
            flex-shrink: 0;
            overflow: visible;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-controls {
            order: 0;
            width: auto;
            margin-left: auto;
            flex: 0 1 auto;
        ...
        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-rate-inline {
            width: 4.4rem;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-meta-rate {
            min-width: 3.6rem;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-sheet-tour-cost .q-tour-cost-traveller-sub {
            display: none;
        }
        ...
        .crm-quotation-gen .q-pricing-sheets-host.is-single-option .q-sheet-tour-cost .q-tour-cost-traveller-sub {
            display: block;
        }
        ...
        .crm-quotation-gen .q-pricing-option-sheet .q-profit-pct-group .form-control.q-sum-pct {
            width: 3.25rem;
            max-width: 3.25rem;
            flex: 0 0 3.25rem;
            height: 36px;
        ...
        .crm-quotation-gen .q-pricing-option-sheet .q-profit-pct-group .form-control.q-sum-pct:focus {
            border: 0 !important;
            box-shadow: none !important;
            outline: 0;
        }

        .crm-quotation-gen .q-pricing-option-sheet .q-profit-pct-suffix {
            display: inline-flex;
            align-items: center;
            justify-content: center;
            flex: 0 0 2rem;
        ...
        .crm-quotation-gen .q-pricing-add-label {
            min-height: 40px;
            height: 40px;
            background: transparent !important;
            border-left-color: transparent !important;
        ...
        .crm-quotation-gen .q-pricing-row-label.has-add-cost {
            display: flex;
            flex-direction: row;
            flex-wrap: nowrap;
            align-items: center;
        ...
        .crm-quotation-gen .q-pricing-labels-col .q-add-cost-row {
            flex: 0 0 26px;
            width: 26px;
            min-width: 26px;
            height: 26px;
            ...
            align-items: center;
            justify-content: center;
            border: 1.5px dashed rgba(196, 18, 26, 0.55);
            border-radius: 7px;
            background: #fff;
            color: #c4121a;
            line-height: 1;
        ...
        .crm-quotation-gen .q-pricing-labels-col .q-add-cost-row:hover {
            color: #fff;
            background: #c4121a;
            border-style: solid;
            border-color: #c4121a;
        ...
        .crm-quotation-gen .q-pricing-labels-col .q-add-cost-row i {
            font-size: 0.68rem;
            margin: 0;
        }
        ...
        .crm-quotation-gen .q-pricing-labels-col .q-pricing-option-body {
            background: transparent;
            padding: 0.75rem 0.35rem 0.85rem 0;
            gap: 0;
        }
        ...
        .crm-quotation-gen .q-pricing-option-sheet .q-custom-cost .q-pricing-amount-input-wrap {
            flex: 0 0 7.75rem;
            width: 7.75rem;
            min-width: 7.75rem;
            max-width: 7.75rem;
        ...
        .crm-quotation-gen .q-pricing-add-cell.is-spacer {
            visibility: hidden;
        }
        ...
        .qp-header-text .q-preview-header-text,
        .q-preview-header-text {
            display: inline-block;
            max-width: 100%;
        ...
        .qp-flight-seg-row {
            display: grid;
            grid-template-columns: minmax(150px, 1.35fr) minmax(0, 1.05fr) minmax(78px, 0.65fr) minmax(0, 1.05fr);
            gap: 2px 10px;
            align-items: start;
        }
        ...
        .qp-flight-baggage .q-preview-cell-edit {
            font-size: 10px;
            color: #64748b;
            border-bottom: none !important;
            white-space: nowrap;
        ...
        .qp-flight-mid-col {
            ...
            min-width: 0;
            padding: 0;
            /* Sit level with city/date/time (skip From/To label height) */
            margin-top: 13px;
            align-self: start;
        }
        ...
        @media screen and (max-width: 720px) {
            ...
            body:not(.q-preview-only) .qp-flight-seg-card {
                min-width: 560px;
            }

            body:not(.q-preview-only) .qp-flight-sec-top {
                flex-wrap: wrap;
            }

            body:not(.q-preview-only) .qp-flight-sec-rule {
                display: none;
            }

            body:not(.q-preview-only) .qp-flight-sec-slogan-wrap {
                width: 100%;
                align-items: flex-start;
            }
        }
        ...
        .qp-meal-legend-label {
            font-weight: 700;
            color: var(--qp-ink);
            margin-right: 2px;
        }

        .qp-meal-legend-item strong {
            font-weight: 700;
            color: var(--qp-red);
        }
        ...
        .qp-hotel-col-head .qp-hotel-field {
            display: inline-flex;
            align-items: center;
            gap: 3px;
            font-size: 8.5px;
        ...
        .qp-hotel-col-head .qp-hotel-field span {
            min-width: 0;
            overflow: hidden;
            text-overflow: ellipsis;
            white-space: nowrap;
        ...
        .qp-hotel-col-head .qp-hotel-field:last-child {
            border-right: none;
            padding-right: 0;
        }
        ...
        .qp-hotel-col-head .qp-hotel-field-nights,
        .qp-hotel-col-head .qp-hotel-field-date,
        .qp-hotel-col-head .qp-hotel-field-meals {
            justify-content: center;
            text-align: center;
        }

        .qp-hotel-row-fields .qp-hotel-field-nights,
        .qp-hotel-row-fields .qp-hotel-field-date,
        .qp-hotel-row-fields .qp-hotel-field-meals {
            text-align: center;
        }

        .qp-hotel-row-fields .qp-hotel-field-nights .qp-hotel-field-value,
        .qp-hotel-row-fields .qp-hotel-field-date .qp-hotel-field-value,
        .qp-hotel-row-fields .qp-hotel-field-meals .qp-hotel-field-value,
        .qp-hotel-row-fields .qp-hotel-field-nights .qp-hotel-primary,
        .qp-hotel-row-fields .qp-hotel-field-date .qp-hotel-primary,
        .qp-hotel-row-fields .qp-hotel-field-meals .qp-hotel-primary,
        .qp-hotel-row-fields .qp-hotel-field-nights .q-preview-cell-edit,
        .qp-hotel-row-fields .qp-hotel-field-date .q-preview-cell-edit,
        .qp-hotel-row-fields .qp-hotel-field-meals .q-preview-cell-edit {
            text-align: center;
            width: 100%;
        }

        .qp-hotel-col-head .qp-hotel-ico {
            color: var(--qp-hotel-red);
            font-size: 9px;
            width: 10px;
            text-align: center;
        ...
        .qp-hotel-row-fields .qp-hotel-field {
            border-right: 1px solid #e8ecf1;
            padding-right: 6px;
            box-sizing: border-box;
        }

        .qp-hotel-row-fields .qp-hotel-field:last-child {
            border-right: none;
            padding-right: 0;
        }
        ...
        @media screen and (max-width: 640px) {
            ...
            body:not(.q-preview-only) .qp-hotel-field-hotel,
            body:not(.q-preview-only) .qp-hotel-field-city,
            body:not(.q-preview-only) .qp-hotel-field-room {
                grid-column: 1 / -1;
            }

            body:not(.q-preview-only) .qp-hotel-sec-top {
                flex-wrap: wrap;
            }

            body:not(.q-preview-only) .qp-hotel-sec-rule {
                display: none;
            }

            body:not(.q-preview-only) .qp-hotel-sec-slogan {
                width: 100%;
                text-align: left;
                white-space: normal;
            }
        ...
        .qp-travel-details .qp-info-cell {
            flex: 1 1 0;
            min-width: 0;
            padding: 8px 6px;
            box-sizing: border-box;
        ...
        .qp-travel-details .qp-info-cell.qp-cell-wide {
            flex: 2.2 1 0;
            min-width: 9em;
        }

        .qp-travel-details .qp-info-cell.qp-cell-grow {
            flex: 2 1 0;
            min-width: 9em;
        }

        .qp-travel-details .qp-info-cell.qp-cell-date {
            flex: 0 0 auto;
            width: max-content;
            min-width: 6.5em;
            padding-left: 8px;
        ...
        .qp-travel-details .qp-info-cell.qp-cell-narrow {
            flex: 0 0 auto;
            width: max-content;
            min-width: 0;
            max-width: none;
        ...
        .qp-travel-details .qp-info-label {
            white-space: nowrap;
            overflow: hidden;
            text-overflow: ellipsis;
        }

        .qp-travel-details .qp-info-value {
            white-space: nowrap;
            overflow: visible;
            text-overflow: clip;
            word-break: normal;
        ...
        .qp-travel-details .qp-info-cell.qp-cell-wide .qp-info-value,
        .qp-travel-details .qp-info-cell.qp-cell-grow .qp-info-value {
            overflow: visible;
            text-overflow: clip;
        }

        .qp-travel-details .qp-info-value .q-preview-cell-edit,
        .qp-travel-details .qp-info-value .q-preview-editable {
            display: inline;
            white-space: nowrap;
            max-width: none;
        }
        ...
        @media screen and (max-width: 720px) {
            ...
            body:not(.q-preview-only) .qp-day-main.has-photo {
                grid-template-columns: 1fr;
            }

            body:not(.q-preview-only) .qp-day-photo {
                width: 180px;
                margin: 0 auto;
            }

            body:not(.q-preview-only) .qp-day-photo img {
                width: 180px;
                height: 140px;
            }

            body:not(.q-preview-only) .qp-day-sep {
                display: none;
            }

            body:not(.q-preview-only) .qp-day-head {
                gap: 8px;
            }
        }
        ...
        .qp-tc-grand-amt .q-preview-editable,
        .qp-tc-grand-amt .q-preview-cell-edit {
            color: inherit;
            font-weight: inherit;
            font-size: inherit;
            font-family: inherit;
        ...
        @media screen and (max-width: 520px) {
            ...
            body:not(.q-preview-only) .qp-acc-title {
                font-size: 17px;
            }
        }
        ...
        /* Screen-only: print popup must keep 5 equal columns (see print CSS) */
        ...
        .qp-rev-avatar.tone-a { background: #e11d2e; }
        .qp-rev-avatar.tone-b { background: #2563eb; }
        .qp-rev-avatar.tone-c { background: #db2777; }
        ...
        @media (max-width: 800px) {
            body:not(.q-preview-only) .qp-trust-stats,
            body:not(.q-preview-only) .qp-foot-contacts {
                grid-template-columns: repeat(2, minmax(0, 1fr));
                row-gap: 12px;
            }

            body:not(.q-preview-only) .qp-trust-stat.has-sep {
                border-right: 0;
            }

            body:not(.q-preview-only) .qp-trust-stat:nth-child(odd) {
                border-right: 1px solid #e5e7eb;
            }
        }
        ...
        @media (max-width: 480px) {
            ...
            body:not(.q-preview-only) .qp-trust-stat {
                justify-content: flex-start;
            }
        }

        /* —— Footer leftovers (services bar unused in new support layout) —— */
        ...
        @media (max-width: 900px) {
            ...
            body:not(.q-preview-only) .qp-foot-cell + .qp-foot-cell {
                border-left: 0;
            }

            body:not(.q-preview-only) .qp-foot-cell:nth-child(odd) {
                border-right: 1px solid #e5e7eb;
            }
        }
        ...
        @media (max-width: 560px) {
            ...
            body:not(.q-preview-only) .qp-foot-cell {
                padding-left: 0;
            }
        }
        ...
        @media screen and (max-width: 720px) {
            ...
            body:not(.q-preview-only) .qp-ref-card {
                width: 100%;
            }
            ...
            body:not(.q-preview-only) .qp-travel-details .qp-info-cell,
            body:not(.q-preview-only) .qp-travel-details .qp-info-cell.qp-cell-wide,
            body:not(.q-preview-only) .qp-travel-details .qp-info-cell.qp-cell-grow,
            body:not(.q-preview-only) .qp-travel-details .qp-info-cell.qp-cell-date,
            body:not(.q-preview-only) .qp-travel-details .qp-info-cell.qp-cell-narrow {
                flex: none;
                min-width: 0;
                max-width: none;
                width: auto;
            ...
            body:not(.q-preview-only) .qp-cost-notes-row {
                flex-direction: column;
            }

            body:not(.q-preview-only) .qp-tour-card,
            body:not(.q-preview-only) .qp-notes-card {
                flex: none;
                width: 100%;
                max-width: none;
            }

            body:not(.q-preview-only) .qp-tour-tagline {
                display: none;
            }

            body:not(.q-preview-only) .qp-info-cell {
                border-right: none;
                border-bottom: 1px solid #d7e0ea;
                text-align: center;
            }

            body:not(.q-preview-only) .qp-brand {
                max-width: none;
            }

            body:not(.q-preview-only) .qp-logo {
                max-width: none;
            }
            ...
            body:not(.q-preview-only) .qp-info-cell:last-child {
                border-bottom: none;
            }

            body:not(.q-preview-only) .qp-sec-slogan {
                width: 100%;
            }
        }
        ...
        @media print {
            /*
             * Pin memberships + footer to the absolute bottom of the last sheet.
             * Table layout is more reliable in Chrome print than flex + margin-top:auto.
             */
            .qp-print-last-page {
                page: qp-last;
                break-before: page;
                ...
                width: 100% !important;
                /* A4 (297mm) − doc top padding (8mm); full-bleed @page margin 0 */
            ...
            .qp-print-last-page .qp-sec-reviews {
        ...
        @media print {
            ...
            #qPreviewPrintArea .qp-last-main {
                display: table-row !important;
                height: 100% !important;
            }

            #qPreviewPrintArea .qp-last-main-inner {
                display: table-cell !important;
                vertical-align: top !important;
                height: 100% !important;
            }

            #qPreviewPrintArea .qp-last-foot {
                display: table-row !important;
                height: 1px !important;
            }

            #qPreviewPrintArea .qp-last-foot-inner {
                display: table-cell !important;
                vertical-align: bottom !important;
            }

            #qPreviewPrintArea .qp-print-last-page .qp-sec-acc {
                margin-top: 2mm !important;
                padding-top: 0 !important;
            }

            #qPreviewPrintArea .qp-print-last-page .qp-sec-reviews {
                margin-top: 4mm !important;
                padding-top: 2mm !important;
                margin-bottom: 0 !important;
            }
            ...
            #qPreviewPrintArea .qp-print-last-page .qp-support-footer {
                margin-bottom: 0 !important;
                padding-bottom: 0 !important;
                border-bottom: 18px solid #e11d2e !important;
            }
        ...
        [data-theme="dark"] .crm-quotation-gen .q-card-accordions .q-accordion-item,
        [data-theme="dark"] .crm-quotation-gen .q-card-accordions .q-terms-item,
        ...
        [data-theme="dark"] .crm-quotation-gen .q-toolbar,
        [data-theme="dark"] .crm-quotation-gen .q-day-head,
        [data-theme="dark"] .crm-quotation-gen .q-card-accordions .q-accordion-head,
        [data-theme="dark"] .crm-quotation-gen .q-card-accordions .q-terms-item-head,
        [data-theme="dark"] .crm-quotation-gen .q-accordion-head,
        ...
        [data-theme="dark"] .crm-quotation-gen .q-day-svc-btn {
            background: var(--mz-theme-bg-elevated, #2a2e38) !important;
            border-color: var(--q-border) !important;
            color: var(--q-text) !important;
        }

        [data-theme="dark"] .crm-quotation-gen .q-day-svc-btn.is-set {
            background: rgba(198, 40, 40, 0.18) !important;
            border-color: #c62828 !important;
            color: #f87171 !important;
        }

        [data-theme="dark"] .crm-quotation-gen .q-day-svc-menu {
            background: var(--mz-theme-bg-elevated, #2a2e38);
            border-color: var(--q-border);
        }

        [data-theme="dark"] .crm-quotation-gen .q-day-svc-option {
            color: var(--q-text);
        }

        [data-theme="dark"] .crm-quotation-gen .q-day-svc-option:hover,
        [data-theme="dark"] .crm-quotation-gen .q-day-svc-option.active {
        ...
        [data-theme="dark"] .crm-quotation-gen .q-pricing-supplier-remove {
            color: #94a3b8;
        }

        [data-theme="dark"] .crm-quotation-gen .q-pricing-supplier-remove:hover {
            color: #fca5a5;
            background: rgba(225, 29, 46, 0.12);
            border-color: rgba(225, 29, 46, 0.35);
        }

        [data-theme="dark"] .crm-quotation-gen .q-pricing-labels-col .q-add-cost-row {
            background: var(--mz-theme-bg-elevated, #2a2e38) !important;
            border-color: rgba(225, 29, 46, 0.45) !important;
            color: #fca5a5 !important;
        }

        [data-theme="dark"] .crm-quotation-gen .q-pricing-labels-col .q-add-cost-row:hover {
            background: #c4121a !important;
            border-color: #c4121a !important;
            color: #fff !important;
        }
        ...
        [data-theme="dark"] .crm-quotation-gen .q-pricing-option-sheet .q-profit-pct-group {
            background: var(--mz-theme-input-bg, #1e2128) !important;
            border-color: var(--q-border) !important;
        }
        ...
        [data-theme="dark"] .crm-quotation-gen .q-pricing-option-sheet .q-profit-pct-suffix {
            background: var(--mz-theme-bg-muted, #323744) !important;
            border-left-color: var(--q-border) !important;
            color: var(--q-text-muted) !important;
        }
        ...
        [data-theme="dark"] .crm-quotation-gen .q-card-accordions .note-toolbar,
        ...
        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-rate-group,
        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-gst-group,
        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-qty-inline {
            background: var(--mz-theme-bg-muted, #323744) !important;
        }

        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-meta-prefix,
        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-gst-suffix {
            background: var(--mz-theme-bg-elevated, #2a2e38) !important;
            color: var(--q-text-muted) !important;
        }

        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-rate-inline,
        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-qty-inline,
        [data-theme="dark"] .crm-quotation-gen .q-tour-cost-gst-inline {
            background: transparent !important;
            border: 0 !important;
            color: var(--q-text) !important;
        }
            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <form id="quotationForm" autocomplete="off" onsubmit="return false;" data-save-url="crm/ajax/save_quotation.php" data-show-draft="<?= $showSaveDraft ? '1' : '0' ?>">
                        ...
                        <div class="q-card q-section-accordion">
                            <div class="q-section-accordion-head q-wizard-section-head collapsed" data-target="#qSectionBody3" role="button" tabindex="0" aria-expanded="false">
                                <div class="q-section-accordion-head-main">
                                    ...
                                    <p class="q-wizard-section-subtitle">Add, edit or remove hotel options for your customer.</p>
                                </div>
                                <span class="q-section-accordion-toggle" aria-hidden="true"><i class="fas fa-chevron-down toggle-icon"></i></span>
                            </div>
                            ...
                            <div class="q-hotel-table-head" id="qHotelColHead">
                                <div class="q-hotel-head-accom">
                                    <div class="q-hotel-group-title">
                                        <i class="fas fa-bed" aria-hidden="true"></i>
                                        <span>Accommodation Details</span>
                                    </div>
                                    <div class="q-hotel-col-labels q-hotel-col-labels-accom">
                                        <span><i class="fas fa-map-marker-alt" aria-hidden="true"></i>City</span>
                                        <span><i class="fas fa-hotel" aria-hidden="true"></i>Hotel</span>
                                        <span><i class="fas fa-bed" aria-hidden="true"></i>Room Type</span>
                                        <span><i class="fas fa-user-friends" aria-hidden="true"></i>Rooms</span>
                                        <span><i class="fas fa-utensils" aria-hidden="true"></i>Meal</span>
                                        <span><i class="fas fa-moon" aria-hidden="true"></i>Nights</span>
                                        <span><i class="far fa-calendar-alt" aria-hidden="true"></i>Check-in</span>
                                        <span><i class="far fa-calendar-alt" aria-hidden="true"></i>Check-out</span>
                                    </div>
                                </div>
                                <div class="q-hotel-head-commercial">
                                    <div class="q-hotel-group-title">
                                        <i class="fas fa-coins" aria-hidden="true"></i>
                                        <span>Commercial Details</span>
                                    </div>
                                    <div class="q-hotel-col-labels q-hotel-col-labels-commercial">
                                        <span><i class="fas fa-rupee-sign" aria-hidden="true"></i>Rate (₹)</span>
                                        <span><i class="fas fa-building" aria-hidden="true"></i>Supplier</span>
                                        <span class="q-hotel-col-head-action">Actions</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="q-card q-card-accordions q-section-accordion q-inclusions-section">
                            <div class="q-section-accordion-head q-wizard-section-head collapsed" data-target="#qSectionBody5" role="button" tabindex="0" aria-expanded="false">
                                <div class="q-section-accordion-head-main">
                                    <h3 class="q-section-title">Inclusions</h3>
                                    <p class="q-wizard-section-subtitle">Add what is included and excluded in this quotation.</p>
                                </div>
                                <span class="q-section-accordion-toggle" aria-hidden="true"><i class="fas fa-chevron-down toggle-icon"></i></span>
                            </div>
                        ...
                        <?php
                        $inclusionSections = crmQuotationInclusionFields();
                        foreach ($inclusionSections as $field => $label):
                            if ($quotation) {
                                $val = (string) ($quotation[$field] ?? '');
                            } elseif ($field === 'exclusion') {
                                $val = (string) ($prefill[$field] ?? ($quotationTermsMaster[$field] ?? ''));
                            } else {
                                $val = (string) ($prefill[$field] ?? '');
                            }
                            ?>
                        ...
                        <div class="q-card q-card-accordions q-section-accordion q-terms-section">
                            <div class="q-section-accordion-head q-wizard-section-head collapsed" data-target="#qSectionBody6" role="button" tabindex="0" aria-expanded="false">
                                <div class="q-section-accordion-head-main">
                                    ...
                                    <p class="q-wizard-section-subtitle">Load master terms or customize payment, cancellation, and other policies.</p>
                                </div>
                                <span class="q-section-accordion-toggle" aria-hidden="true"><i class="fas fa-chevron-down toggle-icon"></i></span>
                            </div>
                            ...
                            <div class="q-terms-list">
                        <?php
                        $richSections = crmQuotationPolicyFields();
                        ...
                        <?php endforeach; ?>
                            ...
                            <div class="q-section-next-bar">
                                <button type="button" class="btn btn-sm q-section-next-btn" data-q-next-from="6">
                                    Next <i class="fas fa-arrow-right ml-1"></i>
                                </button>
                            </div>
                            </div>
                        ...
                        <!-- Pricing -->
                        <div class="q-wizard-step" id="qWizardSection7" data-q-step="7">
                            <div class="q-card q-pricing-card q-section-accordion">
                            <div class="q-section-accordion-head q-wizard-section-head collapsed" data-target="#qSectionBody7" role="button" tabindex="0" aria-expanded="false">
                                <div class="q-section-accordion-head-main">
                                    <h3 class="q-section-title">Pricing</h3>
                                </div>
                                <span class="q-section-accordion-toggle" aria-hidden="true"><i class="fas fa-chevron-down toggle-icon"></i></span>
                            </div>
                            <div class="q-section-accordion-body" id="qSectionBody7" style="display:none;">
                            ...
                            <input type="hidden" id="q_children_ages" name="children_ages" value="[]">
                            <input type="hidden" id="q_children_qtys" name="children_qtys" value="[]">

                            <div class="q-check-row q-check-row-master d-none" aria-hidden="true">
